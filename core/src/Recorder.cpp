...
{
    auto write16 = [this](uint16_t value) { wavFile.write(reinterpret_cast<const char*>(&value), 2); };
    auto write32 = [this](uint32_t value) { wavFile.write(reinterpret_cast<const char*>(&value), 4); };
